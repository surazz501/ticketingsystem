    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="logo-area">
                    <a><span style="font-size: 23px;color: white;border: 1px solid white;padding-left: 5px;padding-right: 5px;">Ticketing System</span>
                    </a>
                    {{--<a href="#"><img src="{{asset('theme/img/logo/logo.png')}}" alt="" /></a>
             --}}   </div>
            </div>
                    ...
                    <ul class="nav navbar-nav notika-top-nav">
                        <li class="nav-item dropdown">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                               class="nav-link dropdown-toggle"><span><i class="fa fa-search"></i></span></a>
                        ...
                        <li class="nav-item dropdown">
                            <a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                               class="nav-link dropdown-toggle"><span><i class="fa fa-envelope-o"></i></span></a>
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false"
                                                class="nav-link dropdown-toggle"><span><i
                                            class="fa fa-comment-o"></i></span></a>
